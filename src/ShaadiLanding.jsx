          ...
          <div className="flex flex-col justify-center max-w-2xl mx-auto md:mx-0 md:ml-[10%] px-4 sm:px-0 animate-fadeInUp">
            ...
            <div className="flex flex-col gap-3 mb-6">
              ...
              <div className="flex items-center justify-start gap-3">
                ...
                <a href="sms:+14699967434&body=Hey%20Hemanth!%20Saw%20your%20profile%20and%20loved%20it!" className="w-10 h-10 flex items-center justify-center bg-[#007AFF]/20 border border-[#007AFF]/40 rounded-full text-[#007AFF] hover:bg-[#007AFF] hover:text-white transition-all hover:-translate-y-1 backdrop-blur-md" title="iMessage (US)">
                  <MessageCircle size={18} />
                </a>
                <a href="facetime-audio:bommenahemanth@gmail.com" className="w-10 h-10 flex items-center justify-center bg-[#007AFF]/20 border border-[#007AFF]/40 rounded-full text-[#007AFF] hover:bg-[#007AFF] hover:text-white transition-all hover:-translate-y-1 backdrop-blur-md" title="FaceTime Audio">
                ...
                <a href="tel:+14699967434" className="w-10 h-10 flex items-center justify-center bg-emerald-600/20 border border-emerald-500/40 rounded-full text-emerald-400 hover:bg-emerald-600 hover:text-white transition-all hover:-translate-y-1 backdrop-blur-md" title="Call US: +1 469-996-7434">
                  <Phone size={18} />
                </a>
              </div>
            </div>
