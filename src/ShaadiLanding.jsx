        ...
        <div className="relative z-20 container mx-auto px-6 h-full flex flex-col justify-center">
          ...
          <div className="flex flex-col justify-center max-w-2xl mx-auto md:mx-0 md:ml-[10%] px-4 sm:px-0 animate-fadeInUp">
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <a href="facetime-audio:bommenahemanth@gmail.com" className="w-10 h-10 flex items-center justify-center bg-gray-600/20 border border-gray-500/40 rounded-full text-gray-400 hover:bg-gray-600 hover:text-white transition-all hover:-translate-y-1 backdrop-blur-md" title="FaceTime Audio">
              ...
              <a href="https://www.facebook.com/bommenahemanth" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center bg-blue-700/20 border border-blue-600/40 rounded-full text-blue-500 hover:bg-blue-700 hover:text-white transition-all hover:-translate-y-1 backdrop-blur-md">
                <Facebook size={18} />
              </a>
              <a href="tel:+14699967434" className="w-10 h-10 flex items-center justify-center bg-emerald-600/20 border border-emerald-500/40 rounded-full text-emerald-400 hover:bg-emerald-600 hover:text-white transition-all hover:-translate-y-1 backdrop-blur-md" title="US: +1 469-996-7434">
                <Phone size={18} />
              </a>
            </div>
