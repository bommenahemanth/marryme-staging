...
export const ALL_CITIES = [
  "Hyderabad", "Secunderabad", "Warangal", "Nizamabad", "Karimnagar", "Khammam", "Ramagundam", "Mahbubnagar", "Nalgonda", "Adilabad", "Suryapet", "Miryalaguda", "Jagtial", "Siddipet", "Mancherial", "Kothagudem", "Paloncha", "Bhadrachalam", "Kamareddy", "Sangareddy", "Vikarabad", "Wanaparthy", "Gadwal", "Nirmal", "Asifabad", "Mulugu",
  "Visakhapatnam", "Vijayawada", "Guntur", "Nellore", "Kurnool", "Rajahmundry", "Kakinada", "Tirupati", "Kadapa", "Anantapur", "Vizianagaram", "Eluru", "Ongole", "Nandyal", "Machilipatnam", "Adoni", "Tenali", "Proddatur", "Chittoor", "Hindupur", "Bhimavaram", "Madanapalle", "Guntakal", "Dharmavaram", "Gudivada", "Srikakulam", "Narasaraopet", "Tadipatri", "Tadepalligudem", "Amaravati",
...
export const TIMELINE_DATA = [
  ...
  },
  {
    ...
    responsibilities: [
      "📺 Watched Mahabharat during lockdown",
      "🏃 Jogged 10km everyday",
      "💻 Entire course was online due to COVID"
    ],
    facts: [
      "📊 Grade: 78%",
      "🛠️ Skills: R · ML · Python · SQL · Power BI · Tableau · Simul8",
      "💻 Birthplace of the MODERN COMPUTER — Alan Turing",
  ...
  },
  {
    ...
    responsibilities: [
      ...
      "📱 Volunteered Tester in XDA Developers Community",
      "🏃 Conducted Marathon for Carbon Conscious Awareness"
    ],
    facts: [
      "📊 Grade: 8.15 CGPA",
      "🛠️ Skills: Excel · Team Leadership · SolidWorks",
      "🏆 India's #1 private engineering university",
      "🤖 Alumni created PyTorch — powering Tesla, Meta & OpenAI"
    ]
  },
  {
    id: 7,
    ...
    responsibilities: [
      "📚 Study, Eat and Sleep — No social life whatsoever",
      "🎯 Focused on competitive exam preparation",
      "😤 Tried for NIT but ended up in VIT"
    ],
    facts: [
      "🏆 97.5% - State Top 1%",
      "💰 Scholarships from Central & State Government",
      "📈 Known for producing IIT/NIT toppers"
    ]
  },
  {
    id: 8,
    ...
    responsibilities: [
      "🎒 12 wonderful years of learning",
      "👫 Made amazing friends & great memories",
