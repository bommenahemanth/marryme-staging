...
export default function ShaadiLanding() {
  ...
  return (
    <div className="h-screen w-full overflow-y-scroll bg-black text-white font-sans selection:bg-[#D4AF37] selection:text-black scroll-smooth snap-y snap-mandatory">
        ...
        <div className="relative z-20 container mx-auto px-6 h-full flex flex-col justify-center">
          ...
          <div className="absolute top-6 left-6 flex flex-col gap-2">
            ...
            <div className="flex gap-3">
              <a href="https://www.linkedin.com/in/bommena-hemanth-2a2834118/" target="_blank" rel="noopener noreferrer" className="p-2.5 bg-blue-600/20 border border-blue-500/40 rounded-full text-blue-400 hover:bg-blue-600 hover:text-white transition-all hover:-translate-y-1 backdrop-blur-md">
                <Linkedin size={16} />
              </a>
              <a href="https://www.instagram.com/bommenahemanth/" target="_blank" rel="noopener noreferrer" className="p-2.5 bg-pink-600/20 border border-pink-500/40 rounded-full text-pink-400 hover:bg-pink-600 hover:text-white transition-all hover:-translate-y-1 backdrop-blur-md">
                <Instagram size={16} />
              </a>
              <a href="https://wa.me/918124269822?text=Hey%20Hemanth!%20%F0%9F%91%8B%0A%0AJust%20saw%20your%20profile%20and%20loved%20it!%20%E2%9C%A8%0AWould%20love%20to%20connect%20and%20get%20to%20know%20you%20better.%20%F0%9F%98%8A" target="_blank" rel="noopener noreferrer" className="p-2.5 bg-green-600/20 border border-green-500/40 rounded-full text-green-400 hover:bg-green-600 hover:text-white transition-all hover:-translate-y-1 backdrop-blur-md">
                <MessageCircle size={16} />
              </a>
              <a href="mailto:bommenahemanth@gmail.com?subject=Hey%20Hemanth!%20Loved%20your%20profile%20%E2%9C%A8&body=Hi%20Hemanth!%20%F0%9F%91%8B%0A%0AI%20just%20saw%20your%20profile%20and%20really%20liked%20it!%0AWould%20love%20to%20connect%20and%20chat.%20%F0%9F%98%8A%0A%0ALooking%20forward%20to%20hearing%20from%20you!" className="p-2.5 bg-red-600/20 border border-red-500/40 rounded-full text-red-400 hover:bg-red-600 hover:text-white transition-all hover:-translate-y-1 backdrop-blur-md">
                <Mail size={16} />
              </a>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-center max-w-2xl mt-8 mx-auto">
            <div className="mb-6 group relative">
              <h1 className="text-5xl lg:text-7xl font-serif tracking-tight leading-none mb-2">
      ...
      <div ref={journeySectionRef} className="relative w-full min-h-screen flex flex-col bg-black snap-start">
        ...
        <div className="z-30 w-full px-8 py-6 flex justify-between items-center bg-gradient-to-b from-black/80 to-transparent sticky top-0 backdrop-blur-md">
          <div>
        ...
        <div className="text-center my-8 relative z-20 px-4">
          <p className="text-gray-300 max-w-2xl mx-auto font-serif text-xl leading-relaxed">
            ...
            {TIMELINE_DATA.map((item, idx) => {
              ...
              return (
                <div key={item.id} className={`relative flex flex-col md:flex-row items-center gap-8 ${isEven ? 'md:flex-row-reverse' : ''}`}>
                  <div className="flex-1 w-full md:w-[45%] h-[180px] group perspective-1000">
                    <div
                    ...
                    >
                      <div
                        className="absolute inset-0 bg-[#050505] border border-[#D4AF37]/20 rounded-xl p-3 shadow-2xl flex flex-col hover:border-[#D4AF37]/50 hover:shadow-[#D4AF37]/10 transition-all hover:-translate-y-1 z-20 scale-100 hover:scale-[1.02]"
